...
public class AiTranslationSettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        TextCheckCell switchGeneral = new TextCheckCell(context);
        ...
        switchGeneral.setTextAndCheck(LocaleController.getString(R.string.EnableAITranslation), false, false);
        switchGeneral.setColorfullIcon(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText), R.drawable.settings_translation);
        switchGeneral.setOnClickListener(v -> switchGeneral.setChecked(!switchGeneral.isChecked()));
        ...
        final TextView targetLanguageValue = new TextView(context);
        targetLanguageValue.setText(LocaleController.getString(R.string.AiTranslationContent));
        ...
        switchAutoDetectIncoming.setTextAndCheck(LocaleController.getString(R.string.EnableAITranslation), true, false);
